...
export function Workflow({isHoveringGithub}: WorkflowArgs) {
  return (
    ...
    ${isHoveringGithub ? "blur" : ""}`}>
      ...
      <CardContent className="p-0 text-sm font-normal text-neutral-600 dark:text-neutral-400 max-w-sm">
        Follow the workflow behind Renderex through commits, structure, and refactoring.
      </CardContent>
    </Card>
  );
}
    ...
    <div ref={scope} className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-2">
          <IoLogoFirebase className="h-6 w-6 dark:text-white" />
        </Container>
